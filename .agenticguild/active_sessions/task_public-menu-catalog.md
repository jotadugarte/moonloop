...
<implementation_plan>
  ...
  <steps>
    ...
    <step order="2" status="pending">Request specs catálogo público: `PublicMenusController` (o nombre alineado) `GET` index solo `publicly_shareable`; `GET` show; 404 si no público o revocado; HTML sin email del autor; rutas y controlador mínimos.</step>

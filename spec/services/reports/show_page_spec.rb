...
RSpec.describe Reports::ShowPage do
  ...
  describe ".call" do
    ...
    # [REQ-RPT-002]
    it "falls back to live streak calculation for today when persisted counters are stale" do
      category = create(:habit_category, user: user)
      habit = create(:user_habit,
        user: user,
        habit_category: category,
        ...
        activation_date: Date.new(2026, 4, 1),
        active: true,
        current_streak_today: 999,
        longest_streak_through_today: 999,
        streak_counters_as_of: Date.new(2026, 4, 20),
    ...
    # [REQ-RPT-002]
    it "falls back to live streak calculation for today when persisted counters are not fresh (as_of != today)" do
      category = create(:habit_category, user: user)
      habit = create(:user_habit,
        user: user,
        habit_category: category,
        ...
        current_streak_today: 999,
        longest_streak_through_today: 999,
        streak_counters_as_of: Date.new(2026, 4, 19),
        streak_counters_stale: false)

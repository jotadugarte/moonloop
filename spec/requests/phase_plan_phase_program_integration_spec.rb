...
RSpec.describe "Phase plan + plans integration", type: :request do
  ...
  # [REQ-PHS-001]
  it "shows active menu and routine from Phases::WeekNumber after applying a plan bundle" do
    ...
    program = Plan.create!(user: user, name: "Pack", publicly_shareable: false)
  ...
  # [REQ-PHS-001]
  it "surfaces the plans intro and link on the phase dashboard" do
    post sign_in_path, params: { email: user.email, password: "Password123!" }
